...
if (session.getAttribute("memberSession") == null) {
	response.sendRedirect("/faces/account.jsp");
} 
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										<form role="form" action="/faces/ReceiptDetailServlet_AddNew" method="post">
										<div class="form-group">
										    ...
										    <a href="/faces/Admin/qlysanpham.jsp"  class="btn btn-danger" style="margin-left:5%">Thoát</a>
										</form>
										<br />
									</div>
								</div>
