...
<!-- <link href="/faces/Admin/assets/css/custom.css" rel="stylesheet" />  -->
 <link href='http://fonts.googleapis.com/css?family=Open+Sans'
	...
	<link rel="stylesheet" href="/faces/css/normalize.min.css">
	<!-- <style type='text/css'>
        .a {
            background: black;
            color: white;
...
<div id="wrapper">
		...
		<div id="page-wrapper">
					...
					<div class="col-md-12">
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="btn btn-success" href="/faces/Admin/GoodReceipt.jsp" style="font-size:14px;padding:8px 12px"> PHIẾU NHẬP</a>
						</div>
		 ...
		 data-id=<%=idgoodReceiptString %> class="btn btn-success" href="/faces/Admin/NewReceipt.jsp?ID_Receipt=<%=goodReceipt.getID_Receipt()%>" style="font-size:14px;padding:8px 12px"> NHẬP THÊM </a>
						</div>
						<div class="btn btn-success" style="padding: 0px 0px;margin-left:20px" >
							<button type="button" class="navbar-toggle"
								data-toggle="collapse" data-target=".sidebar-collapse">
								...
								<a <%if(dateCurrent.compareTo(dateGoodReceipt)>0 ){ %> style="display:none"
		 <% }else if (!acc.getID_Account().equals(goodReceipt.getID_Account())){ %> style="pointer-events: none; background:#DDDDDD;color:black;font-size:14px;padding:8px 12px"<%}else{ %>style=" display:block;pointer-events: auto;font-size:14px;padding:8px 12px"<%}  %>
		 data-id=<%=idgoodReceiptString %> class="btn btn-success" href="/faces/Admin/AddNewReceipt.jsp?ID_Receipt=<%=goodReceipt.getID_Receipt()%>" style="font-size:14px;padding:8px 12px"> NHẬP MỚI </a>
						</div>
