   ...
   <script>
	$(document).ready(function(){
		$("#btnSearch").click(function(){
			...
			$.ajax({
				type: "post",
				url: "/faces/SearchServlet",
				data: {
					textSearch : textSearch
				},
				success : function(response){
					
						window.location.href="http://localhost:8080/faces/index10.jsp"
				...
				<div class="col-sm-6">
					<div class="contactinfo">
						<ul class="nav nav-pills">
							<li><a href="#"><i class="fa fa-phone"></i> +03 860 163 26</a></li>
							<li><a href="#"><i class="fa fa-envelope"></i>
									dovanquyen12a2@gmail.com</a></li>
						</ul>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="social-icons pull-right">
						<ul class="nav navbar-nav">
							<li><a target="_blank" href="https://www.facebook.com/van.bop.3" title="Facebook"><i
					...
					<div class="shop-menu pull-right">
						<ul class="nav navbar-nav">
							...
							<li><a <%if(user!=null){%> style="display:block; " <%}
									...
									<li><a 
										href="/faces/profile.jsp">Thông tin tài khoản</a></li>
										<li><a 
										href="/faces/invoiceDetail.jsp">Xem chi tiết đơn hàng</a></li>
										<li><a 
										href="/faces/invoiceHistory.jsp">Xem lịch sử đơn hàng</a></li>
										<li>
		                            	<a href="/faces/CheckBH.jsp">Bảo hành sản phẩm</a> 
	                        		</li>
										<li><a 
