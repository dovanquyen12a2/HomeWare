...
public class Mail {
	...
	public static String messageForgot(String email) {
		String urlString="http://localhost:8080/faces/ForgotPassword.jsp?email="+email;
	 ...
	 public static boolean sendMail(String to, String subject, String message){
		 ...
		 try{
	         ...
	         String user = "dovanquyen12a2@gmail.com";
	         String pass = "01686016326a";
	         String from = "dovanquyen12a2@gmail.com";
